package com.example.base_ij.jwt.util;
...
import com.example.base_ij.security.user.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    public Boolean refreshTokenValidation(String token) {
        ...
        // DB에 저장한 토큰 비교
        Optional<RefreshToken> refreshToken = refreshTokenRepository.findByMemberNickname(getEmailFromToken(token));
